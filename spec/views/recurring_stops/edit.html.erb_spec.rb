...
describe "recurring_stops/edit" do
  before(:each) do
  ...
  it "renders the edit recurring_stop form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => recurring_stops_path(@recurring_stop), :method => "post" do
